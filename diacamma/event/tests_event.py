...
class EventTest(LucteriosTest):
    ...
    def test_add_remove(self):
        ...
        self.assert_json_equal('', 'event/@0/status', "en création")
    ...
    def test_add_organizer(self):
        ...
        self.assert_json_equal('', 'organizer/@0/isresponsible', "0")
        self.assert_json_equal('', 'organizer/@1/contact', "Luke Lucky")
        self.assert_json_equal('', 'organizer/@1/isresponsible', "0")
        ...
        self.assert_json_equal('', 'organizer/@0/isresponsible', "0")
        self.assert_json_equal('', 'organizer/@1/contact', "Luke Lucky")
        self.assert_json_equal('', 'organizer/@1/isresponsible', "1")
        ...
        self.assert_count_equal('organizer', 2)
        self.assert_json_equal('', 'organizer/@0/contact', "Dalton William")
        self.assert_json_equal('', 'organizer/@0/isresponsible', "1")
        self.assert_json_equal('', 'organizer/@1/contact', "Luke Lucky")
        self.assert_json_equal('', 'organizer/@1/isresponsible', "0")
    ...
    def test_add_participant(self):
        ...
        self.assert_json_equal('', 'participant/@0/is_subscripter', "1")
        self.assert_json_equal('', 'participant/@0/current_degree', "level #1.2 sublevel #3")
        self.assert_json_equal('', 'participant/@0/article_ref_price', "---")
        self.assert_json_equal('', 'participant/@1/contact', "Dalton Jack")
        self.assert_json_equal('', 'participant/@1/is_subscripter', "0")
        self.assert_json_equal('', 'participant/@1/current_degree', '')
        self.assert_json_equal('', 'participant/@1/article_ref_price', "---")
        self.assert_json_equal('', 'participant/@2/contact', "Dalton Joe")
        self.assert_json_equal('', 'participant/@2/is_subscripter', "0")
        self.assert_json_equal('', 'participant/@2/current_degree', '')
        self.assert_json_equal('', 'participant/@2/article_ref_price', "---")
    ...
    def test_validation(self):
        ...
        self.assert_json_equal('LABELFORM', 'name_2', "{[b]}Dalton Jack{[/b]}")
        ...
        self.assert_json_equal('LABELFORM', 'name_3', "{[b]}Dalton Joe{[/b]}")
        ...
        self.assert_json_equal('', 'participant/@0/contact', "Dalton Avrel")
        self.assert_json_equal('', 'participant/@0/is_subscripter', "0")
        self.assert_json_equal('', 'participant/@0/degree_result_simple', '---')
        self.assert_json_equal('', 'participant/@0/subdegree_result', '---')
        self.assert_json_equal('', 'participant/@0/comment', 'trop nul!')
        self.assert_json_equal('', 'participant/@0/article_ref_price', '---')
        self.assert_json_equal('', 'participant/@1/contact', "Dalton Jack")
        self.assert_json_equal('', 'participant/@1/is_subscripter', "0")
        self.assert_json_equal('', 'participant/@1/degree_result_simple', "level #1.5")
        self.assert_json_equal('', 'participant/@1/subdegree_result', '---')
        ...
        self.assert_count_equal('event', 1)
        self.assert_json_equal('', 'event/@0/activity', "activity1")
        self.assert_json_equal('', 'event/@0/status', "validé")
        self.assert_json_equal('', 'event/@0/date_txt', "12 octobre 2014")
        self.assert_json_equal('', 'event/@0/comment', "new examination")
        ...
        self.assert_json_equal('', 'degrees/@0/subdegree', "---")
        ...
        self.assert_json_equal('', 'degrees/@1/subdegree', "---")
    ...
    def test_outing(self):
        ...
        self.assert_count_equal('participant', 3)
        self.assert_count_equal('#participant/actions', 5)
        self.assert_json_equal('LABELFORM', 'date', "12 octobre 2014")
        self.assert_json_equal('LABELFORM', 'date_end', "13 octobre 2014")
        self.assert_json_equal('LABELFORM', "default_article.ref_price", "---")
    ...
    def test_bill(self):
        ...
        self.assert_json_equal('', 'detail/@0/price_txt', '64.10€')
    ...
    def _test_bill_with_family(self):
        ...
        self.assert_json_equal('', 'bill/@0/total', "12.34€")
        self.assert_json_equal('', 'bill/@0/comment', "{[b]}stage/sortie{[/b]}: 12 octobre 2014 -> 13 octobre 2014{[br/]}{[i]}la fiesta{[/i]}{[br/]}Participant : Dalton Avrel")
        self.assert_json_equal('', 'bill/@1/third', "LES DALTONS")
        self.assert_json_equal('', 'bill/@1/total', "54.10€")
        self.assert_json_equal('', 'bill/@1/comment', "{[b]}stage/sortie{[/b]}: 12 octobre 2014 -> 13 octobre 2014{[br/]}{[i]}la fiesta{[/i]}{[br/]}bou!!!!{[br/]}Participant : Dalton Joe")
        self.assert_json_equal('', 'bill/@2/third', "Dalton Avrel")
        self.assert_json_equal('', 'bill/@2/total', "76.44€")
        self.assert_json_equal('', 'bill/@2/comment', "{[b]}cotisation{[/b]}{[br/]}{[i]}type de cotisation{[/i]}: Annually")
