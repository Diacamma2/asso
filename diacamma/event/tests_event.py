...
class EventTest(LucteriosTest):
    ...
    def test_add_remove(self):
        ...
        self.call('/diacamma.event/eventListExamination', {}, False)
        self.assert_observer('core.custom', 'diacamma.event', 'eventListExamination')
        self.assert_count_equal('COMPONENTS/GRID[@name="event"]/HEADER', 4)
        ...
        self.assert_xml_equal('CONTEXT/PARAM[@name="event_type"]', '0')
        ...
        self.assert_count_equal('COMPONENTS/*', 9)
        self.assert_attrib_equal('COMPONENTS/LABELFORM[@name="activity"]', "description", "passion")
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="activity"]', 'activity1')

        self.factory.xfer = EventListOuting()
        self.call('/diacamma.event/eventListOuting', {}, False)
    ...
    def test_add_organizer(self):
        ...
        self.assert_observer('core.custom', 'diacamma.event', 'eventShow')
        self.assert_count_equal('COMPONENTS/*', 9)
        self.assert_count_equal('COMPONENTS/GRID[@name="organizer"]/HEADER', 2)
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/HEADER[@name="contact"]', "contact")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/HEADER[@name="isresponsible"]', "responsable")
        self.assert_count_equal('COMPONENTS/GRID[@name="organizer"]/RECORD', 0)
        self.assert_count_equal('COMPONENTS/GRID[@name="organizer"]/ACTIONS/ACTION', 3)
        ...
        self.assert_observer('core.custom', 'diacamma.event', 'eventShow')
        self.assert_count_equal('COMPONENTS/*', 9)
        self.assert_count_equal('COMPONENTS/GRID[@name="organizer"]/RECORD', 2)
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[1]/VALUE[@name="contact"]', "Dalton William")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[1]/VALUE[@name="isresponsible"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[2]/VALUE[@name="contact"]', "Luke Lucky")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[2]/VALUE[@name="isresponsible"]', "0")
        ...
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[1]/VALUE[@name="isresponsible"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[2]/VALUE[@name="contact"]', "Luke Lucky")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[2]/VALUE[@name="isresponsible"]', "1")
        ...
        self.assert_count_equal('COMPONENTS/GRID[@name="organizer"]/RECORD', 2)
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[1]/VALUE[@name="contact"]', "Dalton William")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[1]/VALUE[@name="isresponsible"]', "1")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[2]/VALUE[@name="contact"]', "Luke Lucky")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[2]/VALUE[@name="isresponsible"]', "0")
        ...
        self.assert_observer('core.custom', 'diacamma.event', 'eventShow')
        self.assert_count_equal('COMPONENTS/*', 9)
        self.assert_count_equal('COMPONENTS/GRID[@name="organizer"]/RECORD', 1)
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[1]/VALUE[@name="contact"]', "Luke Lucky")
        self.assert_xml_equal('COMPONENTS/GRID[@name="organizer"]/RECORD[1]/VALUE[@name="isresponsible"]', "0")
    ...
    def test_add_participant(self):
        ...
        self.assert_observer('core.custom', 'diacamma.event', 'eventShow')
        self.assert_count_equal('COMPONENTS/*', 9)
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/HEADER', 4)
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="contact"]', "contact")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="is_subscripter"]', "adhérent ?")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="current_degree"]', "courrant")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="article_ref_price"]', "article")
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/RECORD', 0)
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/ACTIONS/ACTION', 5)
        ...
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="is_subscripter"]', "1")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="current_degree"]', "level #1.2 sublevel #3")
        ...
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="is_subscripter"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="current_degree"]', None)
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="article_ref_price"]', "---")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="contact"]', "Dalton Joe")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="is_subscripter"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="current_degree"]', None)
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="article_ref_price"]', "---")
        ...
        self.assert_observer('core.custom', 'diacamma.event', 'eventShow')
        self.assert_count_equal('COMPONENTS/*', 9)
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/RECORD', 2)
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="contact"]', "Dalton Avrel")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="contact"]', "Dalton Joe")
    ...
    def test_validation(self):
        ...
        self.call('/diacamma.event/eventShow', {"event": 1, 'TRANSITION': 'validate'}, False)
        self.assert_observer('core.custom', 'diacamma.event', 'eventShow')
        self.assert_count_equal('COMPONENTS/*', 5 + 5 * 3)
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="name_1"]', "{[b]}Dalton Avrel{[/b]}")
        self.assert_count_equal('COMPONENTS/SELECT[@name="degree_1"]/CASE', 9)
        self.assert_count_equal('COMPONENTS/SELECT[@name="subdegree_1"]/CASE', 6)
        self.assert_xml_equal('COMPONENTS/MEMO[@name="comment_1"]', "Epreuve 1:{[br/]}Epreuve 2:{[br/]}")
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="name_2"]', "{[b]}Dalton Jack{[/b]}")
        self.assert_count_equal('COMPONENTS/SELECT[@name="degree_2"]/CASE', 10)
        self.assert_count_equal('COMPONENTS/SELECT[@name="subdegree_2"]/CASE', 6)
        self.assert_xml_equal('COMPONENTS/MEMO[@name="comment_2"]', "Epreuve 1:{[br/]}Epreuve 2:{[br/]}")
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="name_3"]', "{[b]}Dalton Joe{[/b]}")
        self.assert_count_equal('COMPONENTS/SELECT[@name="degree_3"]/CASE', 10)
        self.assert_count_equal('COMPONENTS/SELECT[@name="subdegree_3"]/CASE', 6)
        self.assert_xml_equal('COMPONENTS/MEMO[@name="comment_3"]', "Epreuve 1:{[br/]}Epreuve 2:{[br/]}")
        ...
        self.assert_observer('core.custom', 'diacamma.event', 'eventShow')
        self.assert_count_equal('COMPONENTS/*', 9)
        self.assert_count_equal('COMPONENTS/GRID[@name="organizer"]/ACTIONS/ACTION', 0)
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/ACTIONS/ACTION', 1)
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/HEADER', 6)
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="contact"]', "contact")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="degree_result_simple"]', "Grade résultant")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="subdegree_result"]', "Barette résultant")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="comment"]', "commentaire")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="article_ref_price"]', "article")
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/RECORD', 3)
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="contact"]', "Dalton Avrel")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="is_subscripter"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="degree_result_simple"]', '---')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="subdegree_result"]', '---')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="comment"]', 'trop nul!')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="article_ref_price"]', '---')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="contact"]', "Dalton Jack")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="is_subscripter"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="degree_result_simple"]', "level #1.5")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="subdegree_result"]', '---')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="comment"]', 'ça va...')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="article_ref_price"]', '---')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="contact"]', "Dalton Joe")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="is_subscripter"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="degree_result_simple"]', "level #1.3")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="subdegree_result"]', "sublevel #4")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="comment"]', 'bien :)')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="article_ref_price"]', '---')
        ...
        self.assert_count_equal('COMPONENTS/GRID[@name="event"]/RECORD', 1)
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/RECORD[1]/VALUE[@name="activity"]', "activity1")
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/RECORD[1]/VALUE[@name="status"]', "validé")
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/RECORD[1]/VALUE[@name="date_txt"]', "12 octobre 2014")
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/RECORD[1]/VALUE[@name="comment"]', "new examination")
        ...
        self.assert_count_equal('COMPONENTS/GRID[@name="degrees"]/RECORD', 1)
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="degree"]', "[activity1] level #1.2")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="subdegree"]', "sublevel #3")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="date"]', "4 novembre 2011")

        self.factory.xfer = AdherentShow()
        self.call('/diacamma.member/adherentShow', {'adherent': 4}, False)
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="firstname"]', "Jack")
        self.assert_count_equal('COMPONENTS/GRID[@name="degrees"]/RECORD', 2)
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="degree"]', "[activity1] level #1.5")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="subdegree"]', "---")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="date"]', "12 octobre 2014")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[2]/VALUE[@name="degree"]', "[activity2] level #2.2")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[2]/VALUE[@name="subdegree"]', "sublevel #1")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[2]/VALUE[@name="date"]', "9 avril 2012")

        self.factory.xfer = AdherentShow()
        self.call('/diacamma.member/adherentShow', {'adherent': 5}, False)
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="firstname"]', "Joe")
        self.assert_count_equal('COMPONENTS/GRID[@name="degrees"]/RECORD', 2)
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="degree"]', "[activity1] level #1.3")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="subdegree"]', "sublevel #4")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[1]/VALUE[@name="date"]', "12 octobre 2014")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[2]/VALUE[@name="degree"]', "[activity2] level #2.6")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[2]/VALUE[@name="subdegree"]', "---")
        self.assert_xml_equal('COMPONENTS/GRID[@name="degrees"]/RECORD[2]/VALUE[@name="date"]', "21 septembre 2010")
    ...
    def test_no_activity(self):
        ...
        self.call('/diacamma.event/eventListExamination', {}, False)
        self.assert_observer('core.custom', 'diacamma.event', 'eventListExamination')
        self.assert_count_equal('COMPONENTS/GRID[@name="event"]/HEADER', 3)
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/HEADER[@name="status"]', "status")
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/HEADER[@name="date_txt"]', "date")
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/HEADER[@name="comment"]', "commentaire")
        self.assert_count_equal('COMPONENTS/GRID[@name="event"]/RECORD', 0)
    ...
    def test_no_subdegree(self):
        ...
        self.call('/diacamma.event/eventShow', {"event": 1, 'TRANSITION': 'validate'}, False)
        self.assert_observer('core.custom', 'diacamma.event', 'eventShow')
        self.assert_count_equal('COMPONENTS/*', 5 + 4 * 3)
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="name_1"]', "{[b]}Dalton Avrel{[/b]}")
        self.assert_count_equal('COMPONENTS/SELECT[@name="degree_1"]/CASE', 9)
        self.assert_xml_equal('COMPONENTS/MEMO[@name="comment_1"]', "Epreuve 1:{[br/]}Epreuve 2:{[br/]}")
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="name_2"]', "{[b]}Dalton Jack{[/b]}")
        ...
        self.assert_count_equal('COMPONENTS/GRID[@name="organizer"]/ACTIONS/ACTION', 0)
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/ACTIONS/ACTION', 1)
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/HEADER', 5)
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="contact"]', "contact")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="degree_result_simple"]', "Grade résultant")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="comment"]', "commentaire")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/HEADER[@name="article_ref_price"]', "article")
    ...
    def test_outing(self):
        ...
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/RECORD', 3)
        self.assert_count_equal('COMPONENTS/GRID[@name="participant"]/ACTIONS/ACTION', 5)
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="date"]', "12 octobre 2014")
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="date_end"]', "13 octobre 2014")
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="default_article.ref_price"]', "---")
        self.assert_xml_equal('COMPONENTS/LABELFORM[@name="default_article_nomember.ref_price"]', "---")
        ...
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/RECORD[1]/VALUE[@name="activity"]', "activity1")
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/RECORD[1]/VALUE[@name="status"]', "validé")
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/RECORD[1]/VALUE[@name="date_txt"]', "12 octobre 2014 -> 13 octobre 2014")
        self.assert_xml_equal('COMPONENTS/GRID[@name="event"]/RECORD[1]/VALUE[@name="comment"]', "outing")
        self.assert_xml_equal('CONTEXT/PARAM[@name="event_type"]', '1')
    ...
    def test_bill(self):
        ...
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="contact"]', "Dalton Jack")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="is_subscripter"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="article_ref_price"]', 'ABC2 [56.78€]')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="contact"]', "Dalton Joe")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="is_subscripter"]', "0")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="article_ref_price"]', 'ABC2 [56.78€]')
        ...
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="contact"]', "Dalton Avrel")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="article_ref_price"]', 'ABC1 [12.34€]')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[1]/VALUE[@name="comment"]', None)
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="contact"]', "Dalton Jack")
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="article_ref_price"]', '---')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[2]/VALUE[@name="comment"]', 'blabla')
        self.assert_xml_equal('COMPONENTS/GRID[@name="participant"]/RECORD[3]/VALUE[@name="contact"]', "Dalton Joe")
        ...
        self.call('/diacamma.invoice/billList', {}, False)
        self.assert_observer('core.custom', 'diacamma.invoice', 'billList')
        self.assert_count_equal('COMPONENTS/GRID[@name="bill"]/RECORD', 3)
        self.assert_count_equal('COMPONENTS/GRID[@name="bill"]/HEADER', 7)
        ...
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[3]/VALUE[@name="third"]', "Dalton Avrel")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[3]/VALUE[@name="total"]', "76.44€")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[3]/VALUE[@name="comment"]', "{[b]}cotisation{[/b]}{[br/]}{[i]}type de cotisation{[/i]}: Annually")
    ...
    def test_bill_with_family(self):
        ...
        self.factory.xfer = AdherentFamilySelect()
        self.call('/diacamma.member/adherentFamilySelect', {'adherent': 4, 'legal_entity': 7}, False)
        self.assert_observer('core.acknowledge', 'diacamma.member', 'adherentFamilySelect')
        self.factory.xfer = AdherentFamilySelect()
        self.call('/diacamma.member/adherentFamilySelect', {'adherent': 5, 'legal_entity': 7}, False)
        self.assert_observer('core.acknowledge', 'diacamma.member', 'adherentFamilySelect')

        self.factory.xfer = EventAddModify()
        self.call('/diacamma.event/eventAddModify', {"SAVE": "YES", "comment": "la fiesta", "date": "2014-10-12", "date_end": "2014-10-13", "activity": "1", "event_type": 1, 'default_article': 1, 'default_article_nomember': 2, 'cost_accounting': 2}, False)
        self.assert_observer('core.acknowledge', 'diacamma.event', 'eventAddModify')
        ...
        self.factory.xfer = OrganizerResponsible()
        self.call('/diacamma.event/organizerResponsible', {"event": 1, 'organizer': '1'}, False)
        self.assert_observer('core.acknowledge', 'diacamma.event', 'organizerResponsible')

        self.factory.xfer = ParticipantSave()
        self.call('/diacamma.event/participantSave', {"event": 1, 'pkname': 'contact', 'contact': '2;4;5'}, False)
        self.assert_observer('core.acknowledge', 'diacamma.event', 'participantSave')

        self.factory.xfer = ParticipantModify()
        self.call('/diacamma.event/participantModify', {"event": 1, "participant": 2, "SAVE": "YES", 'comment': 'blabla', 'article': 0}, False)
        self.assert_observer('core.acknowledge', 'diacamma.event', 'participantModify')
        self.factory.xfer = ParticipantModify()
        self.call('/diacamma.event/participantModify', {"event": 1, "participant": 3, "SAVE": "YES", 'comment': 'bou!!!!', 'article': 5, 'reduce': 10.0}, False)
        self.assert_observer('core.acknowledge', 'diacamma.event', 'participantModify')
        ...
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[1]/VALUE[@name="total"]', "12.34€")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[1]/VALUE[@name="comment"]', "{[b]}stage/sortie{[/b]}: 12 octobre 2014 -> 13 octobre 2014{[br/]}{[i]}la fiesta{[/i]}{[br/]}Participant : Dalton Avrel")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[2]/VALUE[@name="third"]', "LES DALTONS")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[2]/VALUE[@name="total"]', "54.10€")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[2]/VALUE[@name="comment"]', "{[b]}stage/sortie{[/b]}: 12 octobre 2014 -> 13 octobre 2014{[br/]}{[i]}la fiesta{[/i]}{[br/]}bou!!!!{[br/]}Participant : Dalton Joe")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[3]/VALUE[@name="third"]', "Dalton Avrel")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[3]/VALUE[@name="total"]', "76.44€")
        self.assert_xml_equal('COMPONENTS/GRID[@name="bill"]/RECORD[3]/VALUE[@name="comment"]', "{[b]}cotisation{[/b]}{[br/]}{[i]}type de cotisation{[/i]}: Annually")
