...
class AdherentTest(BaseAdherentTest):
    ...
    def test_subscription_doc(self):
        ...
        self.assert_count_equal('COMPONENTS/*', 2 + (19 + 5) + 2 + 5 + 3 + 2)  # header + identity/docs + subscription + financial + invoice + grade
    ...
    def test_subscription_withoutparams(self):
        ...
        self.assert_count_equal('COMPONENTS/*', 2 + (15 + 5) + 2 + 5 + 3 + 2)  # header + identity + subscription + financial + invoice + grade
...
class AdherentFamilyTest(BaseAdherentTest):
    ...
    def test_show_adherent(self):
        ...
        self.assert_observer('core.custom', 'diacamma.member', 'adherentShow')
        self.assert_count_equal('COMPONENTS/*', 2 + (15 + 2 + 5) + 2 + 5 + 3 + 2)  # header + identity/family/docs + subscription + financial + invoice + grade
        self.assert_count_equal('COMPONENTS/GRID[@name="subscription"]/HEADER', 5)
