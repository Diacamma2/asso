...
class AssoTest(BaseAdherentTest):
    ...
    def test_config(self):
        ...
        self.assert_count_equal('', 2 + 5 + 6 + 13 + 3)
        ...
        self.assert_action_equal('POST', self.json_comp["20@Adhérents_btn"]['action'],
                                 ("Modifier", 'mdi:mdi-pencil-outline', 'CORE', 'paramEdit', 0, 1, 1, {'params': ["member-family-type", "member-connection", "member-subscription-mode", "member-size-page", 'member-default-categorybill', "member-tax-receipt", 'member-tax-receipt-payoff', "member-tax-exclude-payoff", "member-tax-reason-payoff", 'member-activegroup', 'member-renew-filter']}))
